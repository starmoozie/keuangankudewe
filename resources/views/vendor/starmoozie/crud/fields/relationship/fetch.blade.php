                        ...
                        if ($includeAllFormFields) {
                            ...
                            for (var i=0; i < $dependencies.length; i++) {
                                ...
                                if(typeof element.attr('data-custom-selector') != 'undefined') {
                                    ...
                                    if(dependency_val){
                                        formSerializeArray.push({name: $dependency, value: dependency_val, name: 'key', value: rowNumber - 1});
                                    }
                                }
                            }
                    ...
                    processResults: function (data, params) {
                        ...
                        var result = {
                            results: $.map(data.data, function (item) {
                                ...
                                let id  = item[$connectedEntityKeyName];
                                let key = isObject(id) ? JSON.stringify(id) : id;
