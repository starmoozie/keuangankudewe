...
/**
 * Configurations for Starmoozie's ListOperation.
 *
 * @see https://starmoozieforlaravel.com/docs/crud-operation-list
 */
...
return [
    ...
    'pageLengthMenu' => [[10, 25, 50, 100, -1], [10, 25, 50, 100, 'starmoozie::crud.all']],
